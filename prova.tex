...
\DeclareExerciseTranslation{Brazilian}{points}{pontos}
\DeclareExerciseTranslation{Brazilian}{reached}{Atingido}
\xsimsetup{
    question/print = true,
    answer/print = true
}
...
\begin{tcolorbox}[center title,title=\textbf{\large Instruções}, coltitle=black, colbacktitle=mydarkgray, colframe=black, colback=mylightgray]
	...
	\begin{itemize}[leftmargin=1mm]
	    \item Fique tranquilo, a prova abordará o que foi visto e exercitado em aula.
	    \item A prova é individual e sem consulta a qualquer material.
	    \item Somente respostas escritas à caneta serão reavaliadas.
	    \item Após a leitura da prova pelo professor, ficam proibidas perguntas de interpretação.
	    ...
	    \item Só é permitida a entrega da prova transcorridos 20 minutos do seu início.
            \item O uso de aparelhos celulares/\textit{smarthphones}/\textit{smartwatches} é proibido.
            \item Coloque o seu nome de forma legível em todas as folhas/rascunhos da prova.
...
% Questions
\begin{question}[points=2.0, subtitle={Questão do Enade}, topics={Algoritmos Gulosos}]
